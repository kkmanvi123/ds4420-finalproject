...
def load_visitation_data(
    ...
    cols = ["NACCID", "VISITYR", "VISITMO", "VISITDAY", "NACCMMSE", "NACCMOCA", "CDRSUM", "MEMORY", "CDRLANG", "DEMENTED"]
...
def prepare_visit_df(visit_df: pd.DataFrame) -> pd.DataFrame:
    ...
    target_cols = ["NACCMMSE", "NACCMOCA", "CDRSUM", "MEMORY", "CDRLANG", "DEMENTED"]
    missing_codes = [-4, 88, 95, 96, 97, 98, 99]
